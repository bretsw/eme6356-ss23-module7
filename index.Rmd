...
[bretsw.com/eme6356-ss23-module7](https://bretsw.com/eme6356-ss23-module7)
...
include_graphics("img/7-data-story1.png")
```
...
include_graphics("img/7-data-story2.png")
```

"Testing out Stable Diffusion inpainting on a video" (Tweet from [@karenxcheng](https://twitter.com/karenxcheng/status/1587510079770615809))
...
include_graphics("img/7-data-story3.png")
```
...
(Tweet from [@stevekrenzel](https://twitter.com/stevekrenzel/status/1589700736207949824))

---

class: inverse, center, middle

# `r fa("thumbs-up", fill = "#fff")` <br><br> Module 6 <br> Discussion Themes

---

# `r fa("thumbs-up", fill = "#fff")` Ethics of Measurement
...
# `r fa("thumbs-up", fill = "#fff")` Ethics of Collection
...
# `r fa("thumbs-up", fill = "#fff")` Ethics of Analysis
...
# `r fa("thumbs-up", fill = "#fff")` Ethics of Reporting
...
# `r fa("thumbs-up", fill = "#fff")` Recommended Solutions
...
# `r fa("fas fa-question", fill = "#fff")` <br><br> Module 6 Discussion <br> Final Thoughts?
...
What are the most important issues in educational data science in the next 5 years?
...
- Understanding and leveraging data to improve student outcomes
- Developing predictive analytics to support personalized learning 
- Enhancing data-driven decision making
- Leveraging technology to improve learning experiences
- Facilitating the use of data in the classroom
...
include_graphics("img/7-future-analytics.png")
```

<div class="caption">
<p>Midjourney AI art prompt: "futuristic African solarpunk scientists"</p>
</div>
...
```{r, out.width = "450px", echo = FALSE, fig.align = "center"}
include_graphics("img/7-teaching-iteration.png")
```

<div class="caption">
<p>Midjourney AI art prompt: "teaching iteration. pen and ink drawing."</p>
</div>
...
# `r fa("fas fa-calendar-day", fill = "#fff")` <br><br> Looking Ahead
...
- Analytics Case Presentation (200 points; group project) - **due April 19**

- Analytics Ethics Statement (100 points) - **due April 30**

---

# `r fa("fas fa-calendar-day", fill = "#fff")` Ethics Statement
...
- related to using analytics to solve a **real-world problem** and 

--

- explain specific ethical concerns of **data collection**, **data analysis**, and **reporting** phases.
